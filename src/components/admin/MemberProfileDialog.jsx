...
import { 
    Phone, Mail, MapPin, Calendar, DollarSign, Edit, MessageSquare, 
    Clock, User, CheckSquare, Plus, X 
} from 'lucide-react';
            ...
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col p-0 gap-0">
                ...
                <div className="bg-stone-50 p-6 border-b border-stone-200 flex justify-between items-start">
                    <div className="flex gap-4">
                        ...
                        <div>
                            <h2 className="text-2xl font-serif font-bold text-stone-900">{fullName}</h2>
                ...
                <div className="flex flex-1 overflow-hidden">
                    ...
                    <div className="w-[400px] bg-stone-50/50 flex flex-col border-l border-stone-200">
