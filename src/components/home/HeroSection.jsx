...
const HeroSection = memo(function HeroSection() {
  ...
  const [showExtendedGallery, setShowExtendedGallery] = useState(false);

  useEffect(() => {
    const id = window.requestIdleCallback
      ? window.requestIdleCallback(() => setShowExtendedGallery(true), { timeout: 1200 })
      : setTimeout(() => setShowExtendedGallery(true), 1200);
