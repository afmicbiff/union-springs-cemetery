...
const COLUMN_RANGES = [
  { start: 185, end: 207, shiftDown: true, bottomPad: 0, topPad: 0, s3Top: null, s4Top: { start: 208, end: 227 } },
  { start: 228, end: 250, shiftDown: true, bottomPad: 0, topPad: 0, s3Top: { start: 251, end: 268 }, s4Top: { start: 269, end: 302 } },
  { start: 303, end: 325, shiftDown: false, s3Top: { start: 326, end: 348 }, s4Top: { start: 349, end: 382 } },
  { start: 383, end: 405, shiftDown: false, s3Top: { start: 406, end: 430 }, s4Top: { start: 431, end: 465 } },
  { start: 466, end: 488, shiftDown: true, s3Top: { start: 489, end: 512 }, s4Top: { start: 513, end: 580 } },
  { start: 582, end: 604, shiftDown: true, s3Top: { start: 605, end: 629 }, s4Top: { start: 630, end: 664 } },
  { start: 665, end: 688, shiftDown: false, s3Top: { start: 689, end: 711 }, s4Top: { start: 712, end: 742 } },
  { start: 743, end: 769, shiftDown: false, s3Top: { start: 770, end: 788 }, s4Top: { start: 789, end: 798 } },
  { start: 799, end: 821, shiftDown: false, s3Top: { start: 822, end: 843 }, s4Top: { start: 844, end: 874 } },
  { start: 875, end: 898, shiftDown: true, s3Top: { start: 899, end: 922 }, s4Top: { start: 923, end: 963 } },
];
        ...
        {s2Columns.map(({ colPlots, s3Plots, s4Plots, bottomPad, topPad }, colIdx) => {
          ...
          return (
            <div key={`s2-${colIdx}`} className="flex flex-col-reverse gap-0.5">
              ...
              {/* Extra bottom padding to align columns */}
              {Array.from({ length: bottomPad || 0 }).map((_, i) => (
                <div key={`bpad-${i}`} className="w-16 h-8 m-0.5" />
              ))}
              {/* Section 2 plots */}
              {colPlots.map((item, rowIdx) => (
                <div key={rowIdx} className={`relative transition-opacity ${baseColorClass} opacity-90 hover:opacity-100 border rounded-[1px] w-16 h-8 m-0.5`}>
