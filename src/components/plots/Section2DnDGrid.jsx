                        ...
                        {(draggableProvided, draggableSnapshot) => (
                          ...
                          >
                            <CellWrapper active={draggableSnapshot.isDragging || snapshot.isDraggingOver}>
                              <div id={`plot-2-${parseNum(item.Grave)}`} className="flex flex-row items-center justify-between px-1.5 w-full h-full text-[8px] overflow-hidden select-none font-bold shadow-sm cursor-move transform-gpu will-change-transform plot-element">
