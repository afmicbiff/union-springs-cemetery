...
export default function Section3DnDGrid({ plots = [], baseColorClass = "", isAdmin, onHover, onEdit, statusColors = {} }) {
  ...
  return (
    <div>
      ...
      <DragDropContext onDragEnd={onDragEnd}>
        <Droppable droppableId="s3-grid" direction="horizontal" renderClone={null}>
          {(provided) => (
            <div
