...
export default function Section5DnDGrid({ plots = [], baseColorClass = "", isAdmin, onHover, onEdit, statusColors = {} }) {
  ...
  return (
    <div>
      ...
      <DragDropContext onDragEnd={onDragEnd}>
        <Droppable droppableId="s5-grid" direction="horizontal" renderClone={null}>
          {(provided) => (
            <div
