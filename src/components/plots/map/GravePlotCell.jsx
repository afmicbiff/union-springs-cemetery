...
const GravePlotCell = React.memo(function GravePlotCell({ data, onHover, onClick, hideLabel = false, overrideLabel = null }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col leading-none min-w-0 overflow-hidden">
        {overrideLabel != null ? (
          <span className="text-[9px] font-bold text-gray-800 truncate">#{overrideLabel}</span>
        ) : (
          <>
