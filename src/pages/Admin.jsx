             ...
             <Card>
                ...
                <CardContent className="space-y-6">
                    <div className="prose text-stone-700">
                        <p>
                            <strong>Data Storage:</strong> All cemetery records are securely stored in the cloud database. 
                            This ensures redundancy and access from any authorized device.
                        </p>
                        <p>
                            <strong>Backups:</strong> It is recommended to perform a manual export (using the "Backup Data" button above) 
                            once a month. Save this JSON file to a secure external hard drive or a dedicated organizational cloud storage (e.g., Google Drive, OneDrive).
                        </p>
                        <p>
                            <strong>Restoration:</strong> In the event of data loss, the exported JSON file can be used by the technical team 
                            to restore the database to its previous state.
                        </p>
                        <p>
                            <strong>Access Control:</strong> Only authorized administrators should have access to this dashboard. 
