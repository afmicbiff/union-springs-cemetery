...
export default function BylawsPage() {
    ...
    const handleSearch = (term) => {
        ...
        localStorage.setItem('bylaws_recent_searches', JSON.stringify(newSearches));
    };
    ...
    const HighlightedText = ({ text }) => {
        ...
        // Simple fuzzy-ish regex: split search terms and find them case-insensitive
        try {
        ...
        <div className="min-h-screen bg-stone-200 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="text-center space-y-4">
                    <h1 className="text-4xl md:text-5xl font-serif text-stone-900">Association By-Laws</h1>
                ...
                {/* Search Bar */}
                <div className="bg-white p-6 rounded-sm shadow-md space-y-4 sticky top-24 z-10 border border-stone-200">
                                ...
                                <SubListItem>
                                    ...
                                    <ul className="mt-2 space-y-2">
                                        <li className="ml-6 list-[circle]">
                                            <HighlightedText text="Place the first urn 12 inches from the headstone base or marker, centered on the plot. The second urn should be placed 12 inches from the first urn in the row. The third and final urn will be positioned 12 inches from the second urn in the row." />
                                        </li>
                                        <li className="ml-6 list-[circle]">
                                            <HighlightedText text="Dimensional limits: No more than 200 cubic inches, 9 inches tall, and 7 inches in diameter." />
                                        </li>
                                    </ul>
                                </SubListItem>
