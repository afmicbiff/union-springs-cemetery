  ...
  return (
    <div className="space-y-0">
      ...
      <section className="relative h-[60vh] md:h-[500px] flex items-center justify-center bg-[#0c0a09] text-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl space-y-6 animate-fade-in-up -mt-[224px]">
      ...
      <section className="py-16 px-4 md:px-8 bg-stone-200">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 -mt-[224px] relative z-20">
          ...
          <div className="bg-slate-50 p-8 rounded-sm shadow-md hover:shadow-xl transition-shadow duration-300 group">
            ...
            <Link to={createPageUrl('Search')} className="text-red-700 font-semibold uppercase text-sm tracking-widest hover:text-red-800 flex items-center gap-1">
              Search Records &rarr;
            </Link>
          </div>
          ...
          <div className="bg-slate-50 p-8 rounded-sm shadow-md hover:shadow-xl transition-shadow duration-300 group">
            ...
            <span className="text-red-700 font-semibold uppercase text-sm tracking-widest hover:text-red-800 flex items-center gap-1 cursor-pointer">
              View Florists &rarr;
            </span>
          </div>
