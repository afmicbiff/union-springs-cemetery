        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 sm:gap-3">
            <img
              ...
              alt="Union Springs Cemetery logo"
            ...
            <div className="flex flex-col min-w-0">
              <span className="text-xl sm:text-2xl md:text-3xl font-serif tracking-wider uppercase text-teal-600 truncate">
                Union Springs
              </span>
              <span className="text-[0.6rem] sm:text-[0.7rem] md:text-xs text-stone-500 tracking-[0.2em] uppercase">
                Cemetery - Shongaloo, LA
              </span>
            </div>
          </div>
          <div className="mt-4 text-center md:text-left">
            ...
            <p className="text-sm text-gray-500 mt-0.5">
              Explore newly available plots prepared for reservations.
            </p>
          </div>
        </div>
      </header>
