                        ...
                        <div className="flex gap-4 justify-center overflow-x-auto pb-4">
                            {(() => {
                                const columnsConfig = [
                                    ...
                                    { ranges: [{ start: 548, end: 559 }, { start: 560, end: 562 }, { start: 564, end: 576 }], spacers: [{ target: 559, position: 'after' }, { target: 562, position: 'after' }], extraBottom: [547] },
