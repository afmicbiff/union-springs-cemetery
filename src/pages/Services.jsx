        ...
        <div className="text-center space-y-6">
          ...
          <div className="text-stone-600 max-w-2xl mx-auto text-lg leading-relaxed text-left">
            ...
            <ol className="list-decimal list-inside ml-4 space-y-4 text-left text-stone-600">
                ...
                <li>Maintenance Fees – A minimum donation of <strong>$400 secures a plot</strong>. Members must reaffirm intent to use the plot every five years, the Association will attempt to verify contact for one year. If no contact is successful the plot will revert to the Association.</li>
            </ol>
